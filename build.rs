//! Build script — embed the AutoShade icon into the Windows executables so the
...
fn main() {
    #[cfg(windows)]
    {
        println!("cargo:rerun-if-changed=assets/autoshade.ico");
        let mut res = winresource::WindowsResource::new();
        res.set_icon("assets/autoshade.ico");
