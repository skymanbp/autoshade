...
- **分区探针的准入臂在这一对上一次也没发货**：四个越线区域全部问了单元、全部被拒（天空 0.865/0.135/1.000，两块瓦片 0.328/0.660/0.979 与 0.149/0.595/0.387，自由蒙版 0.397/0.598/0.441），天空的颜色增益仍是 [1.00 1.00 1.00]。天空从 18.2 ΔE 回到 5.9 靠的是 §D3 的 cast 臂（0.966/0.017/0.937 带过 [Aqua, Blue]）、§D4 的颜色场（0.85 时 88 个已测单元准入 **81** 个、上限 0.61；1.0 时 80 个、上限 0.80）与 §D5 的分区影调。§D2 的发货路径钉在 fixture 上，在这一对上它交付的是**测量过的拒绝**，而 R33 在同一处印的是沉默。
