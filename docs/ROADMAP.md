...
- **v0.23.5 RELEASED（2026-08-12，第十四轮=用户试用反馈三连）** — tag
  ...
  反推暗闷** —— 三机制已亲证（fit.rs:390-394 do-no-harm 整体回退成中性且
  fit_zoned.rs:248-252 零区照叠其上、色彩三闸拒大区域转色 fit.rs:335-341、
  零区 EV-增益归一化错配 fit_zoned.rs:146-155/467-468）；用户 17:53 清盘抹
  了当轮残差/注记证据，待合成靶按 GUI 域（中性源、无盖戳）离线复现定罪后
  给修法选项拍板。
