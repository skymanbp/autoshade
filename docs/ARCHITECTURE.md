...
**The source frame is one function** (R33 §A, v1.2.7):
...
the reference pair it is the opposite at every scope — frame 0.276 fine /
...
**The colour field as a control (R33 §G, v1.2.7).** Past
...
was DISCLOSURE ONLY until R33 §G (v1.2.7): the field is an owned local of
