...
static ZH_ENTRIES: &[(&str, &str)] = &[
    ...
    ("AI", "AI"),
    ("AI Analyze", "AI 分析"),
    ("AI proposes a recipe (GPT proposal + validation), written into the sliders — undoable. Direction / Refine / Style live in the AI section of the Develop panel.",
        "AI 提案配方（GPT 提案+验证），直接写入滑杆——可撤销。方向 / Refine / 风格在显影面板顶部的 AI 区。"),
    ("Direction", "方向"),
    ("Free-text direction for AI Analyze and Reimagine — e.g. warmer and moodier",
        "给 AI 分析与 Reimagine 的自由文字方向——如「更暖、更有氛围」"),
