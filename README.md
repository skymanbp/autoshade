...
| What | Measured | Where |
|---|---|---|
| Automated test battery | 1044 library / 15 CLI / 145 GUI / 2+2 contract tests; `check_docs` re-derives the pinned release claims | [Tech stack](#tech-stack-algorithms-and-design-philosophy) |
...
Ubuntu and macOS. The current battery is **1044 library (1033 pass + 11 `#[ignore]`d forensic probes) / 15 CLI / 145 GUI / 2+2 contract** tests; the
