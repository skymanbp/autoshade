...
| What | Measured | Where |
|---|---|---|
| Automated test battery | 1761 library / 25 CLI / 223 GUI / 2+2 contract tests; `check_docs` re-derives the pinned release claims | [Tech stack](#tech-stack-algorithms-and-design-philosophy) |
...
- The [`build` workflow](.github/workflows/build.yml) covers default and GUI
  ...
  current battery is **1761 library (1746 pass + 15 `#[ignore]`d forensic probes) / 25 CLI / 223 GUI / 2+2 contract** tests, and
