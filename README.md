...
| What | Measured | Where |
|---|---|---|
| Automated test battery | 1668 library / 25 CLI / 215 GUI / 2+2 contract tests; `check_docs` re-derives the pinned release claims | [Tech stack](#tech-stack-algorithms-and-design-philosophy) |
...
- The [`build` workflow](.github/workflows/build.yml) covers default and GUI
  ...
  current battery is **1668 library (1653 pass + 15 `#[ignore]`d forensic probes) / 25 CLI / 215 GUI / 2+2 contract** tests, and
