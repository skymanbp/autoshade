...
reports 58 symbols + 832 CJK codepoints, all embedded (`subset_gui_fonts.py
--check`, 2026-09-20), and the shipped SC subset measures 833 codepoints /
223,148 bytes where a full CJK face is ~16 MB. Before it, choosing 中文 on a
