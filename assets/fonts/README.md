...
reports 58 symbols + 838 CJK codepoints, all embedded (`subset_gui_fonts.py
--check`, 2026-09-22), and the shipped SC subset measures 839 codepoints /
224,848 bytes where a full CJK face is ~16 MB. Before it, choosing 中文 on a
